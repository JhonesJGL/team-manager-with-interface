...
class UsersController {
  async list(req: Request, res: Response) {
    /*
            #swagger.tags = ["User"];
            #swagger.description = "Endpoint to list the users";

            #swagger.responses[200] = { schema: { data: [{$ref: "#/definitions/UserResponse"}], status:200 } }
            #swagger.responses[500] = { schema: { errors: ["Occured internal error"], status:500 } }
        */
    try {
  ...
  async insert(req: Request, res: Response) {
    /* 
         #swagger.tags = ["User"];
            #swagger.description = "Endpoint to insert an user";
            ...
            #swagger.responses[422] = {schema: {$ref: "#/definitions/UserValidator"} }
            #swagger.responses[500] = { schema: { errors: ["Occured internal error"], status:500 } }
        */
    try {
      ...
      fields.forEach((field, index) => {
        if (!field) {
          fieldsMissing.push(`Field '${fieldsName[index]}' is missing`);
        }
      });
  ...
  async updateUser(req: Request, res: Response) {
    /* 
         #swagger.tags = ["User"];
            #swagger.description = "Endpoint to update an user information";
            ...
            #swagger.responses[201] = { schema: { data: {$ref: "#/definitions/UserResponse"}, status:201 } }
            #swagger.responses[422] = {schema: {$ref: "#/definitions/UserValidator"} }
            #swagger.responses[500] = { schema: { errors: ["Occured internal error"], status:500 } }
        */
    try {
  ...
  async me(req: Request, res: Response) {
    /*
            #swagger.tags = ["User"];
            #swagger.description = "Endpoint to get own user";
